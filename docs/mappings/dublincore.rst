...
These mappings can be used to convert records described following version 4.8 of the DataCite Metadata Schema into records that comply with the Dublin Core Metadata Initiative Schema.
...
The first mapping in :ref:`Table 4` can be used to convert records described following version 4.8 of the DataCite Metadata Schema into records that comply with the Dublin Core Metadata Initiative Schema.
