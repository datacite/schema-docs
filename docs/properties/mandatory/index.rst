...
.. toctree::
    ...
    property_title
    property_publisher
    property_publicationyear
    property_resourcetype

*Guidance for handling missing mandatory property values*

If providing values for any of the mandatory properties presents a difficulty, use of standard machine - recognizable codes is strongly advised. A set of the codes is provided in :doc:`/appendices/appendix_3`. However, we recommend that you consider the resulting effect on the citation created from the metadata provided.
